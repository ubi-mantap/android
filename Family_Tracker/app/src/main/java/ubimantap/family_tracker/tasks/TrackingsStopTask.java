...
public class TrackingsStopTask extends AsyncTask<String, Void, String> {
    private String tag = "TrackingsStopTask";
    private String endpoint = "https://family-tracker.herokuapp.com/trackings/stop";

...
public class TrackingsInitTask extends AsyncTask<String, Void, String> {
    private String tag = "TrackingsInitTask";
    private String endpoint = "https://family-tracker.herokuapp.com/trackings/init";
    ...
    protected String doInBackground(String... strings) {
        ...
        Log.d(tag, trackerUsername + " -> " + trackedUsername);
